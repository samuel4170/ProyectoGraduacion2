      ...
      {isLoggedIn ? (
        ...
        >
          <List>
            ...
            <Collapse in={diaOpen} timeout="auto" unmountOnExit>
              <List component="div" disablePadding>

                <ListItem button onClick={() => handleMenuItemClick('/ver/dia')}
                sx={{ backgroundColor: '#D3DCCB', borderRadius: '10px' }}>
                  <ListItemText style={{ paddingLeft: '16px' }} primary="Ver dias laborales" />
                </ListItem>

                <Divider sx={{ marginY: '0.05rem' }} /> {/* Línea divisora */}

                <ListItem button onClick={() => handleMenuItemClick('/dia/new')}
                sx={{ backgroundColor: '#D3DCCB', borderRadius: '10px' }}>
                  <ListItemText style={{ paddingLeft: '16px' }} primary="Agregar Dia" />
                </ListItem>
